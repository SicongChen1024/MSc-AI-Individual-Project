...
```
## Data
The link to the processed ad dataset is included in data/README.md. The torch tensors are loaded directly to conduct experiments, and the folder should be named 'Ad_training_tensors' placed under the 'data/' directory.
